// Hausa translations were drafted by AI and have not been checked by a
// native speaker. They're a solid starting point for everyday navigation
// and form text, but the Terms page in particular should be reviewed by a
// fluent Hausa speaker before real applicants are asked to rely on it to
...
const en = {
  ...
  "academy.step5Body": "You receive real jobs through Atlas dispatch.",
  "academy.step6Title": "Grow",
  ...
  "academy.ctaBody":
    "Anyone can apply, regardless of background, as long as you meet the criteria above and agree to our terms and conditions.",
  "academy.ctaButton": "Start your application",
  ...
  "terms.s4Title": "4. Accountability",
  "terms.s4Body1":
  ...
  "terms.s6Title": "6. Non-circumvention & confidentiality",
  "terms.s6Body":
    "Customer details shared with you are for completing the assigned job only. You agree not to solicit or accept work directly from a customer introduced through Atlas, outside of Atlas, for a period defined in your individual technician agreement.",
  "terms.s7Title": "7. Independent contractor status",
  "terms.s7Body":
    "You are engaged as an independent contractor/partner, not an employee of Atlas Steward. You are responsible for your own applicable taxes and any required trade permits.",
  "terms.s8Title": "8. Your data",
  "terms.s8Body":
    "Information and the passport photo you submit are used to evaluate your application and, if approved, to create your technician profile. We do not sell your data to third parties.",
  "terms.hausaNote": "",
  ...
  "register.area": "Area / quarters",
  "register.areaPlaceholder": "e.g. Karewa",
  "register.address": "Home address",
  "register.serviceCategory": "Trade / service category",
  "register.selectOne": "Select one",
  "register.yearsExperience": "Years of experience",
  "register.workDescription": "Describe your recent work experience",
  "register.referenceName": "Reference name",
  "register.referencePhone": "Reference phone number",
  "register.photo": "Passport photo",
  "register.photoHint": "Clear, front-facing, under 5MB.",
  "register.agreePrefix": "I have read and agree to the",
  "register.agreeLinkText": "Academy terms and conditions",
  ...
  // Register success
  "registerSuccess.title": "Application received",
  "registerSuccess.body":
    "Thank you for applying to the Atlas Steward Academy. We've sent a confirmation to your email, and our team will review your application and reference within a few days.",
  "registerSuccess.backHome": "Back to home",

  // Contact
  "contact.kicker": "Get in touch",
  "contact.title": "Contact us",
  "contact.subtitle":
    "Have a question about the Academy, a job, or anything else? Reach us directly or send a message below.",
  "contact.infoTitle": "Contact details",
  "contact.phoneLabel": "Phone",
  "contact.whatsappLabel": "WhatsApp",
  "contact.emailLabel": "Email",
  "contact.addressLabel": "Based in",
  "contact.formTitle": "Send us a message",
  "contact.name": "Your name",
  "contact.contactInfo": "Phone number or email",
...
const ha: Record<keyof typeof en, string> = {
  ...
  "home.becomeCta": "Nema yanzu",

  "service.electrical": "Wutar Lantarki",
  "service.plumbing": "Famfo",
  "service.solar": "Hasken Rana",
  "service.carpentry": "Kafinta",
  ...
  "about.p1":
    "Ma'anar 'Steward' ita ce ɗaukar alhakin wani abu da kula da shi yadda ya kamata. Wannan shi ne ƙa'idar da Atlas Steward aka gina a kai — ba kawai haɗa ku da wani gwani ba, sai dai turo muku ƙwararren mutum wanda zai amsa alhakin aikin.",
  "about.p2":
  ...
  "academy.step5Body": "Za ka fara samun ayyuka na gaske ta hanyar Atlas dispatch.",
  "academy.step6Title": "Ci gaba",
  ...
  "academy.ctaBody":
    "Kowa na iya nema, ko da wane irin gogewa yake da shi, muddin ka cika sharuɗɗan da ke sama kuma ka yarda da ka'idojinmu.",
  "academy.ctaButton": "Fara nemanka",
  ...
  "terms.s6Title": "6. Rashin Kaucewa da Sirri",
  "terms.s6Body":
    "Bayanan abokin ciniki da aka ba ka na kammala aikin da aka tura ka ne kawai. Ka yarda ba za ka nemi ko karɓar aiki kai tsaye daga abokin ciniki da Atlas ta gabatar maka ba, a wajen Atlas, na wani lokaci da za a bayyana a yarjejeniyar ka.",
  "terms.s7Title": "7. Matsayin Kai Mai Zaman Kansa",
  "terms.s7Body":
    "An ɗauke ka a matsayin mai zaman kansa/abokin tarayya, ba ma'aikacin Atlas Steward ba. Kai ne ke da alhakin haraji da duk wata takardar izinin sana'a da ake bukata.",
  "terms.s8Title": "8. Bayananka",
  "terms.s8Body":
    "Ana amfani da bayanan da hoton pasfo da ka bayar don duba nemanka, kuma idan an amince da kai, don ƙirƙirar bayanan martabarka. Ba ma sayar da bayananka ga wani ɓangare na uku.",
  "terms.hausaNote":
    "Wannan fassarar Hausa daftari ne na farko. Idan wani abu bai bayyana a fili ba, ko kana da tambaya, don Allah ka tuntuɓi ma'aikatan Atlas Steward kai tsaye kafin ka sanya hannu.",
  ...
  "register.dob": "Ranar haihuwa",
  "register.area": "Unguwa",
  "register.areaPlaceholder": "misali: Karewa",
  "register.address": "Adireshin gida",
  "register.serviceCategory": "Sana'a / nau'in aiki",
  "register.selectOne": "Zaɓi ɗaya",
  "register.yearsExperience": "Shekarun gogewa",
  "register.workDescription": "Bayyana aikin da ka yi kwanan nan",
  "register.referenceName": "Sunan mai shaida",
  "register.referencePhone": "Lambar wayar mai shaida",
  "register.photo": "Hoton pasfo",
  "register.photoHint": "Hoto mai kyau, fuska a bayyane, ƙasa da 5MB.",
  "register.agreePrefix": "Na karanta kuma na yarda da",
  "register.agreeLinkText": "ka'idojin Makarantar",
  ...
  // Register success
  "registerSuccess.title": "An karɓi nemanka",
  "registerSuccess.body":
    "Na gode da neman shiga Makarantar Atlas Steward. Mun aika tabbaci zuwa imel ɗinka, kuma ƙungiyarmu za ta duba nemanka da shaidarka cikin 'yan kwanaki.",
  "registerSuccess.backHome": "Koma gida",

  // Contact
  "contact.kicker": "Tuntuɓe Mu",
  "contact.title": "Tuntuɓe Mu",
  "contact.subtitle":
    "Kana da tambaya game da Makaranta, aiki, ko wani abu daban? Ka tuntuɓe mu kai tsaye ko ka aika saƙo a ƙasa.",
  "contact.infoTitle": "Bayanan tuntuɓa",
  "contact.phoneLabel": "Waya",
  "contact.whatsappLabel": "WhatsApp",
  "contact.emailLabel": "Imel",
  "contact.addressLabel": "Muna a",
  "contact.formTitle": "Aika mana saƙo",
  "contact.name": "Sunanka",
  "contact.contactInfo": "Lambar waya ko imel",
...
export const translations = { en, ha } as const;
